def darth_plagueis_the_wise():
    print('''Did you ever hear the tragedy of Darth Plagueis The Wise? I thought not. 
    ...
    the midichlorians to create life… He had such a knowledge of the dark side that he 
    could even keep the ones he cared about from dying. The dark side of the Force is a 
    pathway to many abilities some consider to be unnatural. He became so powerful… the 
